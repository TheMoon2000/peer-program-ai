    ...
    return <>
        <div className="min-w-80 w-full h-full  scrollbar-thums sb-red scrollbar-track-red">
            {timer === null ? <div className="w-full rounded-lg shadow-lg p-y-4 h-full flex justify-between flex-col">
                ...
                <div className="scrollbar flex flex-col space-y-2 flex-grow overflow-y-auto scrollbar-thumb-red scrollbar-track-red bg-customBGColor01 p-1" ref={containerRef}>
                    {contextHolder}
                    {messages.map((item, i) => (
                        <div key={i}>
